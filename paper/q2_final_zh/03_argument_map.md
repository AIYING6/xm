...
`relay-node failure as structural coordination perturbation`

→ `legal communication/task-support path reconfiguration`

→ `uniform topology randomization may under-emphasize difficult perturbation groups`
...
| Section | Single job | Exit condition |
|---|---|---|
| Introduction | Establish the structural topology-robustness gap and bounded contribution. | Reader knows why the problem differs from noise/blackout and what is tested. |
| Related Work | Position graph MARL, robust MARL, and UAV communication robustness by mechanism. | Reader understands intellectual debt and no-drop-in-comparator boundary. |
