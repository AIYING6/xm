...
def train_ri_gmappo(cfg: RIGMAPPOConfig) -> Path:
    ...
    if drtp_mode not in {"none", "utr", "snr", "drtp"}:
        raise ValueError("drtp_sampler_mode must be none, utr, snr, or drtp")
    ...
    if drtp_mode == "snr":
        ...
        drtp_sampler = DRTPTopologySampler(drtp_mode, sampler_seed, sampler_updates)
    else:
        drtp_sampler = None
