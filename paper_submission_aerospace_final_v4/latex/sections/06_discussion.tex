...
\subsection{6.1 What the formal comparison establishes}
...
\subsection{6.2 Training-cohort sensitivity limits generalization of the gain}
...
\subsection{6.3 Reliability stress tests strengthen the boundary rather than add a method claim}
...
\subsection{6.4 Safety, information-path interpretation, and alternative explanations}
...
\subsection{6.5 Scope and future research}
