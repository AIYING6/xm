...
\subsection{2.1 Heterogeneous relay-failure coordination under a legal information boundary}
...
\subsection{2.2 Relay-node failure as topology/path reconfiguration}
...
\subsection{2.3 Estimands, safety outcomes, and technical validity}
