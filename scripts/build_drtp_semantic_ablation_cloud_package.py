...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="drtp-semantic-ablation-") as temporary:
        ...
        evaluator = evaluator.replace('DRTP-STABILIZATION-FINAL-CONFIRMATION-10M-EVALUATION-V1', 'DRTP-SEMANTIC-ABLATION-NONPAIRED-10M-EVALUATION-V1').replace('DRTP-STABILIZATION-CONFIRMATORY-TAPE-V1', 'DRTP-SEMANTIC-ABLATION-NONPAIRED-TAPE-V1').replace('from run_drtp_stabilization_confirmatory_single import ARMS, SEEDS, STEPS, UPDATES', 'from run_drtp_semantic_ablation_single import ARMS, SEEDS, STEPS, UPDATES')
