"""Generate the sole frozen 420k development evaluation-tape manifest."""
...
PROTOCOL = "DRTP-SG-DEVELOPMENT-TAPE-V1"
TAPE_START = 420000
EPISODES = 100
CONDITIONS = {
    "nominal": None,
...
FORBIDDEN_NAMESPACES = (
    ...
    "380000-380099", "410000-410099", "430000-430099",
)
...
def frozen_manifest() -> dict:
    payload = {
        ...
        "held_out_namespace_reserved_not_generated": "430000-430099",
    }
...
def main() -> None:
    ...
    if not args.execute:
        raise SystemExit("NO-GO: tape creation requires explicit --execute")
    ...
    if path.exists():
        ...
        if existing.get("tape_hash") != manifest["tape_hash"]:
            raise RuntimeError("existing 420k manifest differs from the frozen payload")
    else:
