"""Package the P2.10 read-only forensic audit for a completed P2.9 run."""
...
FILES = (
    ...
    "scripts/run_redundant_topology_uav_p2_10_forensic.py",
    "docs/redundant_topology_uav_p2_10_20260903/P2_10_LEARNING_FORENSIC_CONTRACT.md",
)


def main() -> None:
    target = ROOT / "REDUNDANT_TOPOLOGY_UAV_P2_10_FORENSIC.zip"
    with zipfile.ZipFile(target, "w", zipfile.ZIP_DEFLATED) as archive:
        for folder in ("algorithms", "envs", "scripts"):
            archive.writestr(f"{folder}/__init__.py", f'"""P2.10 isolated {folder}."""\n')
        for rel in FILES:
