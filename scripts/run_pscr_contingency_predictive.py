"""Run the frozen PSCR uncertainty-aware public-planning pilot."""
...
PROTOCOL = "PSCR-CONTINGENCY-PUBLIC-PLAN-P2"


def configure(mode: str) -> None:
    predictive.PSCRPredictiveMAPPO = functools.partial(PSCRContingencyPredictiveMAPPO, planning_mode=mode)
...
def main() -> None:
    ...
    agent = PSCRContingencyPredictiveMAPPO(planning_mode=args.planning_mode)
