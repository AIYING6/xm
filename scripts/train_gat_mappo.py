...
from algorithms.gat_mappo import GATMAPPOConfig, train_gat_mappo


def parse_args() -> GATMAPPOConfig:
    ...
    parser.add_argument("--out-dir", type=str, default=str(ROOT / "results" / "gat_mappo"))
    parser.add_argument("--save-interval", type=int, default=10)
    parser.add_argument("--resume", type=str, default=None)
    args = parser.parse_args()
    return GATMAPPOConfig(
        seed=args.seed,
