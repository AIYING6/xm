...
def build_config(args: argparse.Namespace) -> RIGMAPPOConfig:
    return RIGMAPPOConfig(
        ...
        target_prior_position=tuple(getattr(args, "target_prior_position", (10_000.0, 0.0, 5_000.0))),
        max_target_message_age_steps=getattr(args, "max_target_message_age_steps", 80),
        min_target_confidence=getattr(args, "min_target_confidence", 0.2),
        ...
        attack_hold_steps=getattr(args, "attack_hold_steps", 4),
        min_success_step=getattr(args, "min_success_step", 0),
