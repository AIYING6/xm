...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--updates',type=int,default=60); ap.add_argument('--horizon',type=int,default=180); ap.add_argument('--seeds',type=int,nargs='+',default=[51001,51002]); ap.add_argument('--output',default='results/ler_b1_control_rmnt180.json'); a=ap.parse_args()
    out={"status":"development_only","method":"B1_role_specific","results":[run(s,a.updates,a.horizon) for s in a.seeds]}
