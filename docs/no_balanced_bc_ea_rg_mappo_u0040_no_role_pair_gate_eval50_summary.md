...
| `tracking_rate` | 0.238769 |
| `comm_connectivity` | 0.444484 |
| `mean_message_age` | 55.8352 |
| `collision` | 0 |
| `timeout` | 0.56 |
| `constraint_violation` | 0 |
| `steps` | 165.32 |
| `first_attack_window_step` | 31.48 |
...
| `tracking_during_failure_rate` | 0.499832 |
| `connectivity_during_failure` | 0.121385 |
| `avg_mean_range` | 28385.5 |
| `episode_min_blue_red_distance` | 2202.43 |
| `episode_min_blue_blue_distance` | 4327.5 |
| `final_min_blue_red_distance` | 45609.7 |
| `final_min_blue_blue_distance` | 4914.26 |
