...
Next, integrate the 3DOF experiment narrative into the target manuscript structure. Either create a dedicated next-stage 3DOF English manuscript draft or migrate the 3DOF experiment section into the existing English/LaTeX manuscript after updating the title, abstract, introduction, and method sections to match the 3DOF claim.
