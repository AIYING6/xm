...
- `results/gate1_safety_fx60_failure_timing_generalization_diag5/test_checkpoint_summary.csv`
- `results/gate1_safety_fx60_failure_timing_generalization_delayed55_diag5/test_checkpoint_summary.csv`
...
| dropout030_relay_failure_delayed | no_graph | 0.0 | 0.3 | 0.0 | 80.0 | 0.0 | 4/5 |
| dropout030_relay_failure_delayed | single | 0.0 | 0.5 | 0.0 | 40.0 | 8.0 | 1/5 |
| dropout030_relay_failure_delayed | multi_relation | 4.0 | N/A | N/A | 20.0 | 0.0 | 0/5 |
