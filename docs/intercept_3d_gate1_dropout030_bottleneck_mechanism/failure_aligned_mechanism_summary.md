...
- Curves CSV: `results/intercept_3d_gate1_dropout030_bottleneck_mechanism/failure_aligned_curves.csv`
- Case CSV: `results/intercept_3d_gate1_dropout030_bottleneck_mechanism/representative_case_replay.csv`
- Curves figure: `results/intercept_3d_gate1_dropout030_bottleneck_mechanism/failure_aligned_mechanism_curves.png`
- Case figure: `results/intercept_3d_gate1_dropout030_bottleneck_mechanism/representative_case_timeline.png`
