...
```text
checkpoint = results/paper_config_runs/no_balanced_bc_dev/bc_seed0/ea_rg_mappo/actor_critic_latest.pt
episodes = 30
...
| `tracking_rate` | 0.190452 |
| `comm_connectivity` | 0.462084 |
| `mean_message_age` | 52.4358 |
| `collision` | 0 |
| `timeout` | 0.7 |
...
| `tracking_during_failure_rate` | 0.425536 |
| `connectivity_during_failure` | 0.107639 |
| `avg_mean_range` | 31889.7 |
| `episode_min_blue_red_distance` | 1742.19 |
| `episode_min_blue_blue_distance` | 3685.82 |
| `final_min_blue_red_distance` | 56088.8 |
| `final_min_blue_blue_distance` | 5136.93 |
