...
```text
checkpoint = results/intercept_3d_no_task_support_baseline_smoke/runs/bc_only_seed0/actor_critic_best.pt
episodes = 2
...
| `tracking_rate` | 0.0833333 |
| `comm_connectivity` | 0.298718 |
| `mean_message_age` | 74.5205 |
| `collision` | 0 |
| `timeout` | 1 |
