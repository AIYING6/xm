...
```text
checkpoint = results/intercept_3d_gate1_hardened_safety_5seed_formal_candidate/runs/multi_relation/bc_ppo_seed1/actor_critic_update_0050.pt
episodes = 20
...
| `tracking_rate` | 0.204487 |
| `comm_connectivity` | 0.392821 |
| `mean_message_age` | 59.4188 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 23933.8 |
| `episode_min_blue_red_distance` | 9278.27 |
| `episode_min_blue_blue_distance` | 1279.11 |
| `final_min_blue_red_distance` | 22137.2 |
| `final_min_blue_blue_distance` | 15879.6 |
