...
```text
checkpoint = results/intercept_3d_gate1_hardened_safety_5seed_formal_candidate/runs/multi_relation/bc_ppo_seed1/actor_critic_update_0010.pt
episodes = 20
...
| `tracking_rate` | 0.23141 |
| `comm_connectivity` | 0.413462 |
| `mean_message_age` | 56.286 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 24665.7 |
| `episode_min_blue_red_distance` | 9226.44 |
| `episode_min_blue_blue_distance` | 1590.03 |
| `final_min_blue_red_distance` | 29175 |
| `final_min_blue_blue_distance` | 15965.1 |
