...
```text
checkpoint = results/intercept_3d_gate1_hardened_safety_5seed_formal_candidate/runs/multi_relation/bc_ppo_seed1/actor_critic_update_0060.pt
episodes = 20
...
| `tracking_rate` | 0.201987 |
| `comm_connectivity` | 0.388077 |
| `mean_message_age` | 59.9131 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 24056.2 |
| `episode_min_blue_red_distance` | 9296.95 |
| `episode_min_blue_blue_distance` | 1294.33 |
| `final_min_blue_red_distance` | 22055.2 |
| `final_min_blue_blue_distance` | 17271.1 |
