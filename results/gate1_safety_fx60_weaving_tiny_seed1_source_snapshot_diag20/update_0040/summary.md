...
```text
checkpoint = results/intercept_3d_gate1_hardened_safety_5seed_formal_candidate/runs/multi_relation/bc_ppo_seed1/actor_critic_update_0040.pt
episodes = 20
...
| `tracking_rate` | 0.206859 |
| `comm_connectivity` | 0.401474 |
| `mean_message_age` | 58.2726 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 23781.4 |
| `episode_min_blue_red_distance` | 9296.16 |
| `episode_min_blue_blue_distance` | 1268.19 |
| `final_min_blue_red_distance` | 23196.8 |
| `final_min_blue_blue_distance` | 16972 |
