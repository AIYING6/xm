...
| `attack_window_rate` | 0.00160941 |
| `tracking_rate` | 0.181645 |
| `comm_connectivity` | 0.384175 |
| `mean_message_age` | 60.2742 |
| `collision` | 0 |
| `timeout` | 0.8 |
| `constraint_violation` | 0 |
| `steps` | 248 |
| `first_attack_window_step` | 38.4333 |
| `first_chain_close_step` | 39.2 |
...
| `avg_mean_range` | 23184.5 |
| `episode_min_blue_red_distance` | 7847.16 |
| `episode_min_blue_blue_distance` | 532.431 |
| `final_min_blue_red_distance` | 20163.8 |
| `final_min_blue_blue_distance` | 14465 |
