...
```text
checkpoint = results/intercept_3d_no_role_identity_baseline_formal/runs/bc_ppo_seed0/actor_critic_best.pt
episodes = 30
...
| `attack_window_rate` | 0.0293261 |
| `tracking_rate` | 0.439676 |
| `comm_connectivity` | 1 |
| `mean_message_age` | 43.9682 |
| `collision` | 0 |
| `timeout` | 0 |
