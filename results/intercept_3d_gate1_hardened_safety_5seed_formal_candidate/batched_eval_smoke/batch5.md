...
| `tracking_rate` | 0.0258974 |
| `comm_connectivity` | 0.145128 |
| `mean_message_age` | 89.1904 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `tracking_during_failure_rate` | 0.00916667 |
| `connectivity_during_failure` | 0.0391667 |
| `avg_mean_range` | 20692.1 |
| `episode_min_blue_red_distance` | 4985.89 |
| `episode_min_blue_blue_distance` | 978.689 |
| `final_min_blue_red_distance` | 29898 |
| `final_min_blue_blue_distance` | 14787.4 |
