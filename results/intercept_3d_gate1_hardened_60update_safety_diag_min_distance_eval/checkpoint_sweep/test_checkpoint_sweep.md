...
- Summary rows: `results/intercept_3d_gate1_hardened_60update_safety_diag_min_distance_eval/checkpoint_sweep/test_checkpoint_summary.csv`
- Episode rows: `results/intercept_3d_gate1_hardened_60update_safety_diag_min_distance_eval/checkpoint_sweep/test_episode_metrics.csv`
- Selected checkpoints: `results/intercept_3d_gate1_hardened_60update_safety_diag_min_distance_eval/checkpoint_sweep/test_selected_checkpoints.csv`
