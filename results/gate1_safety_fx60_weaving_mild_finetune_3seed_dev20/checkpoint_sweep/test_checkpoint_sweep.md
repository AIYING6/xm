...
selection_csv = results/gate1_safety_fx60_weaving_mild_finetune_3seed_dev20/checkpoint_sweep/validation_selected_checkpoints.csv
...
- Summary rows: `results/gate1_safety_fx60_weaving_mild_finetune_3seed_dev20/checkpoint_sweep/test_checkpoint_summary.csv`
- Episode rows: `results/gate1_safety_fx60_weaving_mild_finetune_3seed_dev20/checkpoint_sweep/test_episode_metrics.csv`
- Selected checkpoints: `results/gate1_safety_fx60_weaving_mild_finetune_3seed_dev20/checkpoint_sweep/test_selected_checkpoints.csv`
