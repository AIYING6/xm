...
| `attack_window_rate` | 0.0260457 |
| `tracking_rate` | 0.365337 |
| `comm_connectivity` | 0.915897 |
| `mean_message_age` | 42.2289 |
| `collision` | 0 |
| `timeout` | 0.12 |
| `constraint_violation` | 0 |
| `steps` | 71.36 |
| `first_attack_window_step` | 41.7 |
| `first_chain_close_step` | 40.04 |
