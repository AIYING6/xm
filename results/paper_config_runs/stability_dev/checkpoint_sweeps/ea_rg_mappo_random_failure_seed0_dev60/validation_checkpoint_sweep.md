...
| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| scenario_suite | multi_relation | 0 | 60 | legacy_recovery | 0.2 | 0 | inf | inf | 0.4 | `results/paper_config_runs/stability_dev/ea_rg_mappo_seed0_random_failure_h64/actor_critic_update_0060.pt` |
...
- Summary rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_random_failure_seed0_dev60/validation_checkpoint_summary.csv`
- Episode rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_random_failure_seed0_dev60/validation_episode_metrics.csv`
- Selected checkpoints: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_random_failure_seed0_dev60/validation_selected_checkpoints.csv`
