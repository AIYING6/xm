...
| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| scenario_suite | multi_relation | 1 | 60 | delayed_recovery | 0.75 | 0.275 | 81.875 | inf | 0.6 | `results/paper_config_runs/stability_dev/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety_ppo_h64/actor_critic_update_0060.pt` |
...
- Summary rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety_ppo_dev60/validation_checkpoint_summary.csv`
- Episode rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety_ppo_dev60/validation_episode_metrics.csv`
- Selected checkpoints: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety_ppo_dev60/validation_selected_checkpoints.csv`
