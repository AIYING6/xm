...
- Summary rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_offset_balanced_recovery_bc_ppo_seed0_dev60/validation_checkpoint_summary.csv`
- Episode rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_offset_balanced_recovery_bc_ppo_seed0_dev60/validation_episode_metrics.csv`
- Selected checkpoints: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_offset_balanced_recovery_bc_ppo_seed0_dev60/validation_selected_checkpoints.csv`
