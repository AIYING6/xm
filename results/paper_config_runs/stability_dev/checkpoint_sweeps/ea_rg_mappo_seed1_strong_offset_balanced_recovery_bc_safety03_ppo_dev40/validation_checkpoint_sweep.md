...
| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| scenario_suite | multi_relation | 1 | 40 | delayed_recovery | 0.825 | 0.325 | 65.744 | inf | 0.625 | `results/paper_config_runs/stability_dev/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety03_ppo_h64/actor_critic_update_0040.pt` |
...
- Summary rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety03_ppo_dev40/validation_checkpoint_summary.csv`
- Episode rows: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety03_ppo_dev40/validation_episode_metrics.csv`
- Selected checkpoints: `results/paper_config_runs/stability_dev/checkpoint_sweeps/ea_rg_mappo_seed1_strong_offset_balanced_recovery_bc_safety03_ppo_dev40/validation_selected_checkpoints.csv`
