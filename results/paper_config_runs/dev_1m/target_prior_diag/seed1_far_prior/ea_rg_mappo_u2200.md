...
| `attack_window_rate` | 0.00867266 |
| `tracking_rate` | 0.203948 |
| `comm_connectivity` | 0.355609 |
| `mean_message_age` | 121.417 |
| `collision` | 0 |
| `timeout` | 0.7 |
...
| `tracking_during_failure_rate` | 0.40024 |
| `connectivity_during_failure` | 0.0520833 |
| `avg_mean_range` | 19390.3 |
| `episode_min_blue_red_distance` | 3550.54 |
| `episode_min_blue_blue_distance` | 4032.45 |
| `final_min_blue_red_distance` | 17584.5 |
| `final_min_blue_blue_distance` | 25053.8 |
