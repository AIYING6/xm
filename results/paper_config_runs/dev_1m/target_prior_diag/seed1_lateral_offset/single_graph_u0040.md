...
| `comm_connectivity` | 0.387095 |
| `mean_message_age` | 62.36 |
| `collision` | 0 |
| `timeout` | 0.966667 |
...
| `avg_mean_range` | 15113.4 |
| `episode_min_blue_red_distance` | 3930.48 |
| `episode_min_blue_blue_distance` | 1681.63 |
| `final_min_blue_red_distance` | 25705.9 |
| `final_min_blue_blue_distance` | 3374.18 |
