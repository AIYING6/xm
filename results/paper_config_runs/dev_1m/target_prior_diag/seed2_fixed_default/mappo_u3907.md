...
| `tracking_rate` | 0.144915 |
| `comm_connectivity` | 0.330214 |
| `mean_message_age` | 122.274 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `tracking_during_failure_rate` | 0.183889 |
| `connectivity_during_failure` | 0 |
| `avg_mean_range` | 18716.3 |
| `episode_min_blue_red_distance` | 1541.23 |
| `episode_min_blue_blue_distance` | 4485.46 |
| `final_min_blue_red_distance` | 4737.88 |
| `final_min_blue_blue_distance` | 7869.73 |
