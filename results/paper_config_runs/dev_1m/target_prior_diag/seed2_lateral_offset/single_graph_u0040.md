...
| `tracking_rate` | 0.0757265 |
| `comm_connectivity` | 0.515641 |
| `mean_message_age` | 74.212 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `tracking_during_failure_rate` | 0.175 |
| `connectivity_during_failure` | 0 |
| `avg_mean_range` | 29118.4 |
| `episode_min_blue_red_distance` | 1163.47 |
| `episode_min_blue_blue_distance` | 1638.33 |
| `final_min_blue_red_distance` | 53648.6 |
| `final_min_blue_blue_distance` | 4672.11 |
