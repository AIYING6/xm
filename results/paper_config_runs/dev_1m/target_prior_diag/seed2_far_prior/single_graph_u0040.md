...
| `tracking_rate` | 0.0908547 |
| `comm_connectivity` | 0.162393 |
| `mean_message_age` | 98.3316 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `tracking_during_failure_rate` | 0.0643056 |
| `connectivity_during_failure` | 0.0402778 |
| `avg_mean_range` | 22969.8 |
| `episode_min_blue_red_distance` | 4611.26 |
| `episode_min_blue_blue_distance` | 3290.54 |
| `final_min_blue_red_distance` | 20060.9 |
| `final_min_blue_blue_distance` | 25703.9 |
