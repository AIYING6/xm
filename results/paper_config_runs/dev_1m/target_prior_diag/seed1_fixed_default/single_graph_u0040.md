...
| `comm_connectivity` | 0.387352 |
| `mean_message_age` | 62.3308 |
| `collision` | 0 |
| `timeout` | 0.966667 |
...
| `avg_mean_range` | 15114.6 |
| `episode_min_blue_red_distance` | 3930.48 |
| `episode_min_blue_blue_distance` | 1681.63 |
| `final_min_blue_red_distance` | 25748.2 |
| `final_min_blue_blue_distance` | 3338.94 |
