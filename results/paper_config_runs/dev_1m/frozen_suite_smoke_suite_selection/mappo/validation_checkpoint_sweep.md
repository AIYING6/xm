...
| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| scenario_suite | no_graph | 0 | 3907 | legacy_recovery | 0 | 0 | inf | inf | 0 | `results/paper_config_runs/dev_1m/runs/mappo/bc_ppo_seed0/actor_critic_update_3907.pt` |
...
- Summary rows: `results/paper_config_runs/dev_1m/frozen_suite_smoke_suite_selection/mappo/validation_checkpoint_summary.csv`
- Episode rows: `results/paper_config_runs/dev_1m/frozen_suite_smoke_suite_selection/mappo/validation_episode_metrics.csv`
- Selected checkpoints: `results/paper_config_runs/dev_1m/frozen_suite_smoke_suite_selection/mappo/validation_selected_checkpoints.csv`
