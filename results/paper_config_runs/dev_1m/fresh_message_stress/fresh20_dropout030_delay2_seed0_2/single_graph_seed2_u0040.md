...
| `tracking_rate` | 0.0788034 |
| `comm_connectivity` | 0.213184 |
| `mean_message_age` | 62.1634 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `tracking_during_failure_rate` | 0.184306 |
| `connectivity_during_failure` | 0.156458 |
| `avg_mean_range` | 22604.7 |
| `episode_min_blue_red_distance` | 1242.85 |
| `episode_min_blue_blue_distance` | 1316.74 |
| `final_min_blue_red_distance` | 36996.9 |
| `final_min_blue_blue_distance` | 18453.7 |
