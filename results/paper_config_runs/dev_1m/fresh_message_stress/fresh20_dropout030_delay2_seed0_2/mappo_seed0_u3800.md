...
| `tracking_rate` | 0.133376 |
| `comm_connectivity` | 0.188226 |
| `mean_message_age` | 91.6536 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `tracking_during_failure_rate` | 0.174167 |
| `connectivity_during_failure` | 0.169097 |
| `avg_mean_range` | 15372.6 |
| `episode_min_blue_red_distance` | 3538.08 |
| `episode_min_blue_blue_distance` | 2324.79 |
| `final_min_blue_red_distance` | 9581.08 |
| `final_min_blue_blue_distance` | 5818.39 |
