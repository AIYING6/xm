...
| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| relay_failure | no_graph | 1 | 2400 | delayed_recovery | 1 | 0 | 25 | inf | 1 | `results/paper_config_runs/dev_1m/runs/mappo/bc_ppo_seed1/actor_critic_update_2400.pt` |
...
- Summary rows: `results/paper_config_runs/dev_1m/strict_recovery_sweep_smoke/validation_checkpoint_summary.csv`
- Episode rows: `results/paper_config_runs/dev_1m/strict_recovery_sweep_smoke/validation_episode_metrics.csv`
- Selected checkpoints: `results/paper_config_runs/dev_1m/strict_recovery_sweep_smoke/validation_selected_checkpoints.csv`
