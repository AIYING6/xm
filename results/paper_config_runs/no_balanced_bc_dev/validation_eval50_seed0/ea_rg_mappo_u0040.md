...
| `comm_connectivity` | 0.438392 |
| `mean_message_age` | 56.1688 |
| `collision` | 0 |
| `timeout` | 0.56 |
...
| `connectivity_during_failure` | 0.121084 |
| `avg_mean_range` | 28377.4 |
| `episode_min_blue_red_distance` | 2204.17 |
| `episode_min_blue_blue_distance` | 4243.44 |
| `final_min_blue_red_distance` | 45525.9 |
| `final_min_blue_blue_distance` | 5188.36 |
