...
```text
checkpoint = results/paper_config_runs/no_balanced_bc_dev/bc_ppo_seed2/ea_rg_mappo/actor_critic_update_0070.pt
episodes = 50
...
| `comm_connectivity` | 0.454938 |
| `mean_message_age` | 54.5484 |
| `collision` | 0 |
| `timeout` | 0.66 |
...
| `avg_mean_range` | 30893.4 |
| `episode_min_blue_red_distance` | 1852.17 |
| `episode_min_blue_blue_distance` | 3614.87 |
| `final_min_blue_red_distance` | 53962.2 |
| `final_min_blue_blue_distance` | 4759.87 |
