...
```text
checkpoint = results/paper_config_runs/no_balanced_bc_dev/bc_ppo_seed1/ea_rg_mappo/actor_critic_update_0040.pt
episodes = 50
...
| `comm_connectivity` | 0.452156 |
| `mean_message_age` | 54.7353 |
| `collision` | 0 |
| `timeout` | 0.66 |
...
| `avg_mean_range` | 30899.2 |
| `episode_min_blue_red_distance` | 1852.61 |
| `episode_min_blue_blue_distance` | 3539.85 |
| `final_min_blue_red_distance` | 54021.3 |
