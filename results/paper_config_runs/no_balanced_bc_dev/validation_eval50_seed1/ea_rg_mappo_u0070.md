...
```text
checkpoint = results/paper_config_runs/no_balanced_bc_dev/bc_ppo_seed1/ea_rg_mappo/actor_critic_update_0070.pt
episodes = 50
...
| `tracking_rate` | 0.204406 |
| `comm_connectivity` | 0.452143 |
| `mean_message_age` | 54.7351 |
| `collision` | 0 |
| `timeout` | 0.66 |
...
| `tracking_during_failure_rate` | 0.443923 |
| `connectivity_during_failure` | 0.100333 |
| `avg_mean_range` | 30899.3 |
| `episode_min_blue_red_distance` | 1862.11 |
| `episode_min_blue_blue_distance` | 3539.85 |
| `final_min_blue_red_distance` | 54025 |
| `final_min_blue_blue_distance` | 4754.74 |
