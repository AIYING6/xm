...
```text
checkpoint = results/gate1_safety_fx60_weaving_mild_stage1_nominal_dev/stage1_bc/multi_relation/seed2/actor_critic_best.pt
episodes = 30
...
| `tracking_rate` | 0.15812 |
| `comm_connectivity` | 0.608333 |
| `mean_message_age` | 34.1634 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 20015.9 |
| `episode_min_blue_red_distance` | 10248.6 |
| `episode_min_blue_blue_distance` | 1120.41 |
| `final_min_blue_red_distance` | 14655.3 |
| `final_min_blue_blue_distance` | 12848.7 |
