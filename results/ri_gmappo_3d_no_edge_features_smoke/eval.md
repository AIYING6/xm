...
```text
checkpoint = results/ri_gmappo_3d_no_edge_features_smoke/actor_critic_latest.pt
episodes = 1
...
| `tracking_rate` | 0.0666667 |
| `comm_connectivity` | 0.782051 |
| `mean_message_age` | 61.241 |
| `collision` | 0 |
| `timeout` | 1 |
