...
```text
checkpoint = results/canonical_v2/smoke/single_graph/seed0/actor_critic_latest.pt
episodes = 1
...
| `tracking_rate` | 0.048718 |
| `comm_connectivity` | 0.192949 |
| `mean_message_age` | 113.44 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 16670.2 |
| `episode_min_blue_red_distance` | 4122.25 |
| `episode_min_blue_blue_distance` | 2698.24 |
| `final_min_blue_red_distance` | 29991.8 |
| `final_min_blue_blue_distance` | 3733.28 |
