...
```text
checkpoint = results/canonical_v2/smoke/full/seed0/actor_critic_latest.pt
episodes = 1
...
| `comm_connectivity` | 0.233974 |
| `mean_message_age` | 83.9654 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `connectivity_during_failure` | 0.0791667 |
| `avg_mean_range` | 16633.3 |
| `episode_min_blue_red_distance` | 2743.64 |
| `episode_min_blue_blue_distance` | 1331.39 |
| `final_min_blue_red_distance` | 34324.1 |
| `final_min_blue_blue_distance` | 1331.39 |
