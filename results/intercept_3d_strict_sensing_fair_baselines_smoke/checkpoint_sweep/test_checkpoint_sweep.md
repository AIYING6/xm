...
selection_csv = results/intercept_3d_strict_sensing_fair_baselines_smoke/checkpoint_sweep/validation_selected_checkpoints.csv
```
...
- Summary rows: `results/intercept_3d_strict_sensing_fair_baselines_smoke/checkpoint_sweep/test_checkpoint_summary.csv`
- Episode rows: `results/intercept_3d_strict_sensing_fair_baselines_smoke/checkpoint_sweep/test_episode_metrics.csv`
- Selected checkpoints: `results/intercept_3d_strict_sensing_fair_baselines_smoke/checkpoint_sweep/test_selected_checkpoints.csv`
