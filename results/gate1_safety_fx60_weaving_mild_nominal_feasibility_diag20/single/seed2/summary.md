...
```text
checkpoint = results/intercept_3d_gate1_hardened_safety_5seed_formal_candidate/runs/single/bc_ppo_seed2/actor_critic_update_0060.pt
episodes = 20
...
| `tracking_rate` | 0.0876307 |
| `comm_connectivity` | 0.298185 |
| `mean_message_age` | 73.1161 |
| `collision` | 0 |
| `timeout` | 0.95 |
...
| `avg_mean_range` | 31725.6 |
| `episode_min_blue_red_distance` | 10424 |
| `episode_min_blue_blue_distance` | 1131.09 |
| `final_min_blue_red_distance` | 36260.3 |
| `final_min_blue_blue_distance` | 18522.3 |
