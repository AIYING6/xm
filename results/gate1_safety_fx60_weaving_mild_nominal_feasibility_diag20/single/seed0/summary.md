...
```text
checkpoint = results/intercept_3d_gate1_hardened_safety_5seed_formal_candidate/runs/single/bc_ppo_seed0/actor_critic_update_0060.pt
episodes = 20
...
| `tracking_rate` | 0.117821 |
| `comm_connectivity` | 0.317949 |
| `mean_message_age` | 72.4908 |
| `collision` | 0 |
| `timeout` | 1 |
...
| `avg_mean_range` | 26135.8 |
| `episode_min_blue_red_distance` | 9207.46 |
| `episode_min_blue_blue_distance` | 493.696 |
| `final_min_blue_red_distance` | 25701.7 |
| `final_min_blue_blue_distance` | 30373.9 |
