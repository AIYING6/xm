...
| `attack_window_rate` | 0.00446307 |
| `tracking_rate` | 0.291652 |
| `comm_connectivity` | 0.646916 |
| `mean_message_age` | 36.769 |
| `collision` | 0 |
| `timeout` | 0.55 |
| `constraint_violation` | 0 |
| `steps` | 205.15 |
| `first_attack_window_step` | 60.25 |
| `first_chain_close_step` | 61.6 |
...
| `avg_mean_range` | 14859.4 |
| `episode_min_blue_red_distance` | 3423.79 |
| `episode_min_blue_blue_distance` | 1311.51 |
| `final_min_blue_red_distance` | 5746.37 |
| `final_min_blue_blue_distance` | 11015.3 |
