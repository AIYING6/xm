...
|---|---|---:|---:|---:|---:|---:|---|
| `multi_relation` | `multi_relation` | 0 | 30 | 0.9 | 1 | 0 | `results/gate1_oracle_bc_ppo_weaving_mild_seed0_cont30/actor_critic_update_0030.pt` |
...
| `multi_relation` | `multi_relation` | 2 | 25 | 0.7 | 0.8 | 0 | `results/gate1_oracle_bc_ppo_weaving_mild_seed2_cont30/actor_critic_update_0025.pt` |
| `single` | `single` | 0 | 25 | 0.5 | 0.5 | 0 | `results/gate1_oracle_bc_ppo_weaving_mild_single_seed0_cont30/actor_critic_update_0025.pt` |
