...
| `attack_window_rate` | 0.029286 |
| `tracking_rate` | 0.439593 |
| `comm_connectivity` | 0.884101 |
| `mean_message_age` | 85.5196 |
| `collision` | 0 |
| `timeout` | 0 |
...
| `chain_closed_during_failure_rate` | 0.163254 |
| `tracking_during_failure_rate` | 0.998148 |
| `connectivity_during_failure` | 0.191958 |
| `avg_mean_range` | 14809 |
