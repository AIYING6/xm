...
| `attack_window_rate` | 0.000320513 |
| `tracking_rate` | 0.0362821 |
| `comm_connectivity` | 0.266667 |
| `mean_message_age` | 77.6901 |
| `collision` | 0 |
| `timeout` | 1 |
| `constraint_violation` | 0 |
| `steps` | 260 |
| `first_attack_window_step` | 7.85 |
...
| `tracking_during_failure_rate` | 0.00979167 |
| `connectivity_during_failure` | 0.045625 |
| `avg_mean_range` | 21338.9 |
