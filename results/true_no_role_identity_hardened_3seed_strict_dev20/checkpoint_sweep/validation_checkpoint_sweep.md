...
- Summary rows: `results/true_no_role_identity_hardened_3seed_strict_dev20/checkpoint_sweep/validation_checkpoint_summary.csv`
- Episode rows: `results/true_no_role_identity_hardened_3seed_strict_dev20/checkpoint_sweep/validation_episode_metrics.csv`
- Selected checkpoints: `results/true_no_role_identity_hardened_3seed_strict_dev20/checkpoint_sweep/validation_selected_checkpoints.csv`
